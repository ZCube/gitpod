        ...
        <div>
            <PageWithSubMenu subMenu={adminMenu} title="Settings" subtitle="Configure settings for your Gitpod cluster.">
                <CheckBox
                    ...
                    desc={<span>This is used to provide insights on how you use your cluster so we can provide a better overall experience. Read our <a className="gp-link" href="https://www.gitpod.io/privacy">Privacy Policy</a></span>}
